...
A quick example of decoding text that's encoded in CESU-8:
    ...
    >>> import MyPoco.airtestide_lack_packages.ftfy.bad_codecs
...
def search_function(encoding):
    ...
    if norm_encoding in UTF8_VAR_NAMES:
        from MyPoco.airtestide_lack_packages.ftfy.bad_codecs.utf8_variants import CODEC_INFO
        codec = CODEC_INFO
    elif norm_encoding.startswith('sloppy_'):
        from MyPoco.airtestide_lack_packages.ftfy.bad_codecs.sloppy import CODECS
