...
from google.protobuf import service_reflection, descriptor_pb2 as google_dot_protobuf_dot_descriptor__pb2, \
    symbol_database as _symbol_database, service as _service, reflection as _reflection, message as _message, \
