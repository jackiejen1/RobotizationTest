...
local first_recharge_reward_info = {
   _data = {   
    [1] = {1,2,1,1,1,1,"推荐&<99>普通月卡&","充值25元&<99>20倍&返利",5000,3,2058,1,3,11,50,3,21,10,3,2,50,3,9,10,1,3,188888,0,0,0,},  
    [2] = {2,3,3,88,1,1,"推荐&<99>高级月卡&","充值60元&<99>20倍&返利",11800,7,403,1,3,22,30,3,2,300,3,1,4,3,10,20,1,3,888888,0,0,0,},  
    [3] = {3,0,3,188,1,1,"推荐&<99>成长基金&","充值58元&<99>20倍&返利",15800,7,402,1,3,22,50,3,11,300,3,37,100,3,10,50,1,3,1888888,0,0,0,},
    }
}
