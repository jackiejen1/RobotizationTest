...
local transformation_extract_info = {
   _data = {   
    [1] = {100001,100001,"化身抽取第1期",45,46,11,12,1101,0,"","",},  
    [2] = {100002,100002,"化身抽取(开服用)",45,46,11,12,1101,0,"","",},  
    [3] = {100003,100003,"化身抽取(变装)",45,46,11,12,1102,0,"","",},  
    [4] = {100004,100004,"化身1-5，变装",1005,1006,11,12,1103,0,"","",},  
    [5] = {100005,100005,"化身1-4，金装(新服2.2.0)",1005,1006,11,12,1104,0,"","",},  
    [6] = {100006,100006,"化身1-5，金装(2.2.5)",1005,1006,11,12,1105,0,"","",},  
    [7] = {100007,100007,"化身1-5(2.3.0)",1005,1006,11,12,1106,0,"","",},  
    [8] = {100008,100008,"化身1-5(紫金)",1005,1006,11,12,1107,0,"","",},
    }
}
