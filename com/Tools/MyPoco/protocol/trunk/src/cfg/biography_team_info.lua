...
local biography_team_info = {
   _data = {   
    ...
    [16] = {1016,"龙兴凤举",4,7000000,77,1015,101501,3,1,1,5,0,5,50100,85000,500,140016,141016,143006,10016,"气挟风雷无匹敌，志垂日月有光芒。不凡的时代造就不凡的英雄。且看他们如何逐鹿中原，一较高下！",2,},  
    [17] = {1017,"逸气青云",5,27000000000,82,1016,101601,3,1,1,5,0,5,50140,90000,520,140017,141017,143007,10017,"少年怒发上冲冠，争雄乘势、荡海吞江，不坠青云之志。",2,},  
    [18] = {1018,"无双盖世",6,1400000,87,1017,101701,3,1,1,5,0,5,50160,95000,550,140018,141018,143008,10018,"英豪一战，名传百世；盖世功勋，万古长存。",2,},
    }
}
