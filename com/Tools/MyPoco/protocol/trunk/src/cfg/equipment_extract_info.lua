...
local equipment_extract_info = {
   _data = {   
    [1] = {100001,"限时金装第1期",31,32,9,10,901,0,"","",},  
    [2] = {100002,"限时金装(开服版本)",31,32,9,10,902,0,"","",},  
    [3] = {100003,"限时金装(装备、神兵、神兽装备 )",1001,1002,9,10,903,0,"","",},  
    [4] = {100004,"第4期 神兵4、装备、神兽",1001,1002,9,10,904,0,"","",},  
    [5] = {100005,"第5期 神兵1-5",1003,1004,9,10,905,0,"","",},  
    [6] = {100006,"金装(2.2.0)",1003,1004,9,10,906,0,"","",},
    }
}
