...
local warlord_stage_info = {
   _data = {   
    ...
    [4] = {4,10002,22,23,26,"曹操",1,0,172800,104,4,300,520002,25,"乱世奸雄",104,11010,"张角BOSS描述文字",4,1054,1058,1065,1066,0,0,},  
    [5] = {5,10002,27,28,32,"吕布",2,172800,345600,105,5,300,520003,26,"天下无双",105,11011,"董卓BOSS描述文字",5,1070,1073,1075,1080,0,0,},  
    [6] = {6,10002,33,35,38,"于吉",3,345600,604800,106,6,300,520004,27,"符水道人",106,11012,"袁绍BOSS描述文字",6,1084,1087,1098,1099,0,0,},
    }
}
