...
local guild_boss_info = {
   _data = {   
    ...
    [7] = {7,0,2,0,0,50400,20,1,700130,700130,140600,50,10000,30,5000000000,3,10,3,3,240001,240002,2,},  
    ...
    [14] = {14,0,15,0,0,50400,20,1,700130,700130,140600,50,10000,30,5000000000,3,10,3,3,240001,240002,2,},
    }
}
