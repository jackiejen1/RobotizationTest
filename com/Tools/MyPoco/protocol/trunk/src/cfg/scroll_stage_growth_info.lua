...
local scroll_stage_growth_info = {
   _data = {   
    ...
    [35] = {117,2,116,"全队生命+133200；全队防御+4200",4,0,0,1,133200,5,4200,0,0,0,0,},  
    [36] = {118,2,117,"全队攻击+7300；全队生命+141500",4,0,0,2,7300,1,141500,0,0,0,0,},  
    [37] = {10001,5,0,"全体破击率+20%；全体生命+10%",4,0,0,106,200,11,100,0,0,0,0,},  
    [38] = {10002,5,10001,"全体格挡率+20%；全体攻击+10%",4,0,0,105,200,12,100,0,0,0,0,},  
    [39] = {10003,5,10002,"全体命中率+20%；全体防御+10%",4,0,0,101,200,15,100,0,0,0,0,},  
    [40] = {10004,5,10003,"全体闪避率+20%；全体生命+10%",4,0,0,102,200,11,100,0,0,0,0,},  
    [41] = {10005,5,10004,"全体抗暴率+20%；全体攻击+10%",4,0,0,104,200,12,100,0,0,0,0,},  
    [42] = {10006,5,10005,"全体暴击率+20%；全体防御+10%",4,0,0,103,200,15,100,0,0,0,0,},  
    [43] = {10007,5,10006,"全体格挡强度+20%；全体生命+10%",4,0,0,201,200,11,100,0,0,0,0,},  
    [44] = {10008,5,10007,"全体格挡减免+20%；全体攻击+10%",4,0,0,202,200,12,100,0,0,0,0,},  
    [45] = {10009,5,10008,"全体暴击强度+20%；全体防御+10%",4,0,0,203,200,15,100,0,0,0,0,},
    }
}
