...
local dungeon_achievement_info = {
   _data = {   
    ...
    [57] = {57,0,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",9800,9830,999,0,50,9860,999,0,50,9890,999,0,50,9920,999,0,50,9950,999,0,50,9980,999,0,2000,0,0,0,},
    }
}
