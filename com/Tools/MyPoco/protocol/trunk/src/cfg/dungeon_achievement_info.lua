...
local dungeon_achievement_info = {
   _data = {   
    [1] = {1,2,1,200000,"（还差&<5>#num#&星，可获得&<5>高级招将令*10&）","zxcj_zhaojiangling.png","pic_zxcj_zhaojiangling.png","icon_chengjiu_zhaojiangling.png",0,20,3,6,1,30,3,6,1,40,3,6,1,50,3,6,1,60,3,6,1,70,3,6,10,0,0,0,},  
    [2] = {2,3,1,200000,"（还差&<5>#num#&星，可获得&<5>高级招将令*10&）","zxcj_zhaojiangling.png","pic_zxcj_zhaojiangling.png","icon_chengjiu_zhaojiangling.png",70,75,3,6,1,80,3,6,1,90,3,6,1,100,3,6,1,110,3,6,1,120,3,6,10,0,0,0,},  
    [3] = {3,4,1,200000,"（还差&<5>#num#&星，可获得&<5>高级招将令*10&）","zxcj_zhaojiangling.png","pic_zxcj_zhaojiangling.png","icon_chengjiu_zhaojiangling.png",120,130,3,6,1,150,3,6,1,170,3,6,1,200,3,6,1,230,3,6,1,260,3,6,10,0,0,0,},  
    ...
    [52] = {52,53,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",8900,8930,999,0,50,8960,999,0,50,8990,999,0,50,9020,999,0,50,9050,999,0,50,9080,999,0,2000,0,0,0,},  
    [53] = {53,54,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",9080,9110,999,0,50,9140,999,0,50,9170,999,0,50,9200,999,0,50,9230,999,0,50,9260,999,0,2000,0,0,0,},  
    [54] = {54,55,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",9260,9290,999,0,50,9320,999,0,50,9350,999,0,50,9380,999,0,50,9410,999,0,50,9440,999,0,2000,0,0,0,},  
    [55] = {55,56,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",9440,9470,999,0,50,9500,999,0,50,9530,999,0,50,9560,999,0,50,9590,999,0,50,9620,999,0,2000,0,0,0,},  
    [56] = {56,57,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",9620,9650,999,0,50,9680,999,0,50,9710,999,0,50,9740,999,0,50,9770,999,0,50,9800,999,0,2000,0,0,0,},  
    [57] = {57,58,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",9800,9830,999,0,50,9860,999,0,50,9890,999,0,50,9920,999,0,50,9950,999,0,50,9980,999,0,2000,0,0,0,},  
    [58] = {58,59,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",9980,10010,999,0,50,10040,999,0,50,10070,999,0,50,10100,999,0,50,10130,999,0,50,10160,999,0,2000,0,0,0,},  
    [59] = {59,60,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",10160,10190,999,0,50,10220,999,0,50,10250,999,0,50,10280,999,0,50,10310,999,0,50,10340,999,0,2000,0,0,0,},  
    [60] = {60,61,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",10340,10370,999,0,50,10400,999,0,50,10430,999,0,50,10460,999,0,50,10490,999,0,50,10520,999,0,2000,0,0,0,},  
    [61] = {61,62,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",10520,10550,999,0,50,10580,999,0,50,10610,999,0,50,10640,999,0,50,10670,999,0,50,10700,999,0,2000,0,0,0,},  
    [62] = {62,0,1,200000,"（还差&<5>#num#&星，可获得&<5>2000元宝&）","zxcj_yuanbao.png","pic_zxcj_yuanbao.png","icon_chengjiu_yuanbao.png",10700,10730,999,0,50,10760,999,0,50,10790,999,0,50,10820,999,0,50,10850,999,0,50,10880,999,0,2000,0,0,0,},
    }
}
