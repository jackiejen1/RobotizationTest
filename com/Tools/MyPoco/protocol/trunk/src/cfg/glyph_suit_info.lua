...
local glyph_suit_info = {
   _data = {   
    ...
    [19] = {212,2,1,2,2,"鹰纹套装","11","2件激活",2,6000,1,110000,5,3000,102,50,},  
    [20] = {222,2,2,2,3,"狼纹套装","12","2件激活",2,7200,1,140000,5,3600,101,50,},  
    [21] = {232,2,3,2,4,"象纹套装","13","2件激活",2,10200,1,190000,5,5100,102,80,},  
    [22] = {242,2,4,2,5,"虎纹套装","14","2件激活",2,12000,1,230000,5,6000,101,80,},  
    [23] = {252,2,5,2,5,"凤纹套装","15","2件激活",2,15000,1,280000,5,7500,102,120,},  
    [24] = {262,2,6,2,6,"龙纹套装","16","2件激活",2,18000,1,340000,5,9000,101,120,},
    }
}
