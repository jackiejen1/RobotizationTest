...
local knight_star_info = {
   _data = {   
    ...
    [13] = {1,13,161,"巨门",5,"orange","c04923",1,"太微将星",2,1,1008000,52000,25000,25000,13,16,80,0,0,0,0,0,0,},  
    [14] = {1,14,170,"天魁",6,"red","d13718",1,"太微将星",2,1,1617000,84000,41000,41000,14,16,80,0,0,0,0,0,0,},  
    [15] = {1,15,175,"太阳",7,"yellow","ce8026",1,"太微将星",2,1,2520000,132000,64000,64000,15,16,90,0,0,0,0,0,0,},  
    [16] = {1,16,180,"太阴",8,"yellow","dc9e28",1,"太微将星",2,1,3528000,184000,90000,90000,16,16,100,0,0,0,0,0,0,},
    }
}
