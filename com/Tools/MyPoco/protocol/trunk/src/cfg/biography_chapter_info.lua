...
local biography_chapter_info = {
   _data = {   
    ...
    [78] = {78,"吕蒙传",1,285,17,78008,78008,2499,"曹操屯兵皖城，虎视东吴。吕蒙进献奇谋、果断强攻，成功在张辽的援军赶到前攻下皖城。",500160,"新传记开启，将军，您将融入吕蒙之魂，体验名将吕蒙的喜怒哀乐吧！",78001,78101,78201,78301,0,0,0,0,0,0,0,10,1,1,1734,270,1734,270,1035,680,1,16,500,},  
    [79] = {79,"陆逊传",1,290,17,79007,79007,2516,"陆逊看穿吕蒙称病之计，乘机展露才华，假意示弱麻痹关羽，在荆州之战中大放异彩。",510050,"新传记开启，将军，您将融入陆逊之魂，体验名将陆逊的喜怒哀乐吧！",79001,79101,79201,79301,0,0,0,0,0,0,0,10,1,1,1386,1083,1386,1083,693,396,1,16,500,},  
    [80] = {80,"魏延传",1,295,17,80004,80004,2536,"魏延在长沙久不得重用，故而趁刘备攻打长沙时设计斩杀太守韩玄，献城以降刘备。",500100,"新传记开启，将军，您将融入魏延之魂，体验名将魏延的喜怒哀乐吧！",80001,80101,80201,0,0,0,0,0,0,0,0,10,1,1,733,1221,733,1221,709,876,1,16,500,},  
    [81] = {81,"姜维传",1,300,17,81005,81005,2554,"司马师新亡，姜维为继承诸葛亮遗志，力排众议出兵北伐，于狄道城遭遇一生之敌邓艾。",500120,"新传记开启，将军，您将融入姜维之魂，体验名将姜维的喜怒哀乐吧！",81001,81101,81201,81301,0,0,0,0,0,0,0,10,1,1,320,847,320,847,920,557,1,16,500,},  
    [82] = {82,"法正传",1,305,17,82001,82001,2571,"刘备与夏侯渊相持于定军山，法正履出奇谋，设计斩杀夏侯渊，奠定汉中胜局。",400080,"新传记开启，将军，您将融入法正之魂，体验名将法正的喜怒哀乐吧！",82001,82101,82201,82301,0,0,0,0,0,0,0,10,1,1,1230,602,1230,602,472,608,1,16,500,},  
    [83] = {83,"张辽传",1,310,18,83007,83007,2675,"张辽在天柱山不畏道路险恶、勇猛追击，成功平定江淮贼寇之乱。",500020,"新传记开启，将军，您将融入张辽之魂，体验名将张辽的喜怒哀乐吧！",83001,83101,83201,83301,0,0,0,0,0,0,0,10,1,1,1235,1019,1235,1019,1741,997,1,16,500,},  
    [84] = {84,"姜维传",1,315,18,84001,84001,2694,"姜维识破诸葛亮调虎离山之计，将计就计，大败诸葛亮于天水。",500120,"新传记开启，将军，您将融入姜维之魂，体验名将姜维的喜怒哀乐吧！",84001,84101,84201,0,0,0,0,0,0,0,0,10,1,1,421,760,421,760,725,371,1,16,500,},  
    [85] = {85,"太史慈传",1,320,18,85005,85005,2711,"太史慈奉命讨贼，内抚将士、外拒强敌，成功击溃长期在此作乱的刘磐一党，镇服建昌。",500170,"新传记开启，将军，您将融入太史慈之魂，体验名将太史慈的喜怒哀乐吧！",85001,85101,85201,0,0,0,0,0,0,0,0,10,1,1,2008,871,2008,871,968,476,1,16,500,},  
    [86] = {86,"袁绍传",1,325,18,86003,86003,2728,"袁绍通过何进拿到兵权，步步为营，成功诛杀十常侍。",500200,"新传记开启，将军，您将融入袁绍之魂，体验名将袁绍的喜怒哀乐吧！",86001,86101,86201,86301,0,0,0,0,0,0,0,10,1,1,1621,809,1621,809,768,992,1,16,500,},  
    [87] = {87,"庞德传",1,330,18,87004,87004,2745,"庞德忠勇过人，抬棺死战关羽，虚使拖刀计将关羽一箭射伤。",400040,"新传记开启，将军，您将融入庞德之魂，体验名将庞德的喜怒哀乐吧！",87001,87101,87201,0,0,0,0,0,0,0,0,10,1,1,1476,912,1476,912,856,855,1,16,500,},
    }
}
