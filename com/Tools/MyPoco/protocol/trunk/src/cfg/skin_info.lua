...
local skin_info = {
   _data = {   
    ...
    [34] = {70005001,"战神张辽·朔风飞将",70005001,0,1,2,2,},  
    [35] = {70006001,"幼麟姜维·傲雪霜刀",70006001,0,1,2,2,},  
    [36] = {70007001,"赤炎太史慈·皎月丹心",70007001,0,1,2,2,},  
    [37] = {70008001,"天威袁绍·猩红豪爵",70008001,0,1,2,2,},
    }
}
