...
local warlord_info = {
   _data = {   
    ...
    [22] = {22,190001,22,1,22,700,23,600010,0,0,"曹操",22,},  
    [23] = {23,190001,23,1,23,500,26,600010,2875,0,"曹操",22,},  
    [24] = {24,190002,24,0,0,0,0,500040,0,0,"夏侯惇",24,},  
    [25] = {25,190002,25,0,0,0,0,500050,0,0,"夏侯渊",25,},  
    [26] = {26,190001,26,0,0,0,0,600010,2876,0,"乱世枭雄",22,},  
    [27] = {27,190001,27,1,27,600,28,600070,0,0,"吕布",27,},  
    [28] = {28,190001,28,1,28,400,32,600070,2877,0,"吕布",27,},  
    [29] = {29,190002,29,0,0,0,0,510080,0,0,"貂蝉",29,},  
    [30] = {30,190002,30,1,29,0,31,700040,0,0,"吕玲绮",30,},  
    [31] = {31,190002,31,0,0,0,0,700040,2878,0,"怒焰战姬",30,},  
    [32] = {32,190001,32,0,0,0,0,600070,2879,0,"无双战神",27,},  
    [33] = {33,190001,33,1,33,800,34,500210,0,0,"于吉",33,},  
    [34] = {34,190001,34,1,34,400,35,500210,2880,0,"于吉",33,},  
    [35] = {35,190001,35,1,35,300,38,500210,2880,0,"于吉",33,},  
    [36] = {36,190002,36,0,0,0,0,500210,0,0,"真·于吉",36,},  
    [37] = {37,190002,37,0,0,0,0,500210,0,0,"假·于吉",37,},  
    [38] = {38,190001,38,0,0,0,0,500210,0,0,"得道仙人",33,},  
    [39] = {39,190002,39,0,0,0,0,500210,0,0,"真·于吉",39,},  
    [40] = {40,190002,40,0,0,0,0,500210,0,0,"假·于吉",40,},  
    [41] = {41,190002,41,1,34,700,42,300010,0,0,"小怪A-1",41,},  
    [42] = {42,190002,42,1,35,400,43,300010,0,0,"小怪A-2",41,},  
    [43] = {43,190002,43,0,0,0,0,300010,0,0,"小怪A-3",41,},  
    [44] = {44,190002,44,1,34,800,45,300010,0,0,"小怪B-1",44,},  
    [45] = {45,190002,45,1,35,300,46,300010,0,0,"小怪B-2",44,},  
    [46] = {46,190002,46,0,0,0,0,300010,0,0,"小怪B-3",44,},
    }
}
