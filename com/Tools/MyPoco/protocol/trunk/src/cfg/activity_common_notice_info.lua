...
local activity_common_notice_info = {
   _data = {   
    ...
    [37] = {15,1501,3,78,1,5,"恭喜[color=#role_color#]#name#[/color]获得了[color=##quality_color#]#item#[/color]",},  
    [38] = {15,1502,999,0,6666,5,"恭喜[color=#role_color#]#name#[/color]获得了[color=##quality_color#]#item#[/color]*#size#",},  
    [39] = {18,1801,3,164,1,5,"恭喜[color=#role_color#]#name#[/color]获得了[color=##quality_color#]#item#[/color]",},  
    [40] = {18,1802,999,0,6666,5,"恭喜[color=#role_color#]#name#[/color]获得了[color=##quality_color#]#item#[/color]*#size#",},
    }
}
