...
local resource_info = {
   _data = {   
    ...
    [40] = {47,"讨伐魔将次数",202,5,"可用于烽火连城，可随时间自动恢复，也可通过元宝购买恢复",1,0,60,0,122,},  
    [41] = {1000,"元宝",10000,7,"上等的足赤黄金熔炼而成，可用于购买各种珍贵道具和玩法服务。",0,1,1,1,0,},  
    [42] = {1001,"测试全属性",10000,7,"测试账号使用（战斗中的全属性绝对值）",0,0,0,0,0,},  
    [43] = {2000,"武将经验",10015,4,"用于提升武将的等级，可以通过主线副本战斗或使用道具获得。",0,0,0,0,0,},  
    [44] = {2001,"活跃度",10013,4,"通过每日参与活跃任务获得，可用于领取活跃度奖励。",0,0,0,0,0,},  
    [45] = {2002,"武将",10021,5,"武将，可上阵进行战斗且进行武将养成，提升武将属性，招将可获得。",0,0,0,0,0,},  
    [46] = {2003,"合击兵符",10022,5,"合击兵符，觉醒后可上阵释放援助合击，兵符养成可提升全体属性，将魂商店可购买获得。",0,0,0,0,0,},  
    [47] = {2004,"装备",10023,5,"装备，用于上阵武将穿戴和装备养成，增加武将属性，无双试炼可获得。",0,0,0,0,0,},  
    [48] = {2005,"宝物",10024,5,"宝物，用于上阵武将穿戴和宝物养成，增加武将属性，秘境寻宝可获得。",0,0,0,0,0,},  
    [49] = {2006,"称号",10025,5,"称号，用于主角穿戴，激活和穿戴可增加全体武将属性，军团红包、成就和VIP礼包可获得。",0,0,0,0,0,},  
    [50] = {2007,"红包",10026,5,"军团红包，可发放给军团成员领取，获得元宝、银币等资源，军团商店和无双试炼排行奖励中获得。",0,0,0,0,0,},  
    [51] = {2008,"时装",10027,5,"时装，用于主角穿戴和强化，可改变主角形象和主角技能，增加全体属性，军团商店和活动中可获得",0,0,0,0,0,},
    }
}
