...
local login_reward_info = {
   _data = {   
    [1] = {1,1,2,40020,10,1,1,"凤鸣兵符","明天领取&<12>十连抽&",},  
    [2] = {2,2,3,6,10,2,1,"十连招将","明天领取&<12>1888元宝&",},  
    [3] = {3,3,999,0,1888,1,3,"海量元宝","明天领取&<12>绝世时装&",},  
    [4] = {4,4,11,300,1,2,3,"酷炫时装","明天领取&<12>二十连抽&",},  
    [5] = {5,5,3,6,20,1,2,"二十连抽","明天领取&<12>绝世红将&",},  
    [6] = {6,6,3,2061,1,2,2,"绝世红将","明天领取&<12>2888元宝&",},  
    [7] = {7,7,999,0,2888,1,2,"海量元宝","明天领取&<12>绝世红装&",},  
    [8] = {8,8,7,404,1,2,2,"绝世红装","0",},
    }
}
