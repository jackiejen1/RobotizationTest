...
local warlord_achievement_info = {
   _data = {   
    ...
    [2] = {2,"速战速决","1分15秒内通关董卓关卡",3,8,75,0,0,0,2,102,2,999,0,200,3,2,1000,0,0,0,0,0,0,},  
    [3] = {3,"完美胜利","无伤通关袁绍关卡",2,14,1000,0,0,0,2,102,3,999,0,200,3,15,500,0,0,0,0,0,0,},  
    [4] = {4,"暴怒战神","在吕布存活状态下击败貂蝉",4,8,0,13,11,0,3,103,5,999,0,100,3,132,100,0,0,0,0,0,0,},  
    [5] = {5,"直捣黄龙","无视攻城机械直接击败袁绍",4,14,0,14,20,21,3,103,6,999,0,100,3,2,500,0,0,0,0,0,0,},  
    [6] = {6,"力克天公","通关张角关卡",3,1,999,0,0,0,3,103,4,999,0,100,3,15,250,0,0,0,0,0,0,},
    }
}
