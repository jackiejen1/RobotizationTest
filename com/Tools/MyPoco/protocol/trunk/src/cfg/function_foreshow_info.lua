...
local function_foreshow_info = {
   _data = {   
    ...
    [2] = {2,"神将列传",10001,2,2,20,"体验神将列传，感受历史征途","大量产出武将碎片、兵符铸造石、兵符精华等珍稀资源",0,},  
    [3] = {3,"军团",10025,1,15,30,"我们热血同盟，一起征服三国","参加军团副本、军团铸像、可获丰富奖励",0,},  
    [4] = {4,"无双试炼",10009,1,20,40,"实力与策略的双重考验，攀登无双阁巅峰","产出橙装、红装、装备精炼石，打造一流装备",0,},  
    [5] = {5,"日常副本",10030,1,23,50,"日常资源，这里应有尽有","产出武将经验、兵符精华、银币、宝物经验等资源",2007,},  
    [6] = {6,"秘境寻宝",10011,1,35,70,"搜尽天下秘境，炼铸绝世宝物","大量产出宝物、宝物精炼石，打造强力宝物",2011,},  
    [7] = {7,"讨伐巨兽",10024,1,30,60,"打败机械巨兽，豪取战功！","产出兵符和兵符资源、装备资源。",2009,},  
    [8] = {8,"神将列传战役",10032,7,6,55,"大战一触即发，组队横扫三国","大量产出兵符、兵符铸造石、兵符精华等珍稀资源",2010,},  
