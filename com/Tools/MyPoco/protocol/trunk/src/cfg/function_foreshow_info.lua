...
local function_foreshow_info = {
   _data = {   
    [1] = {1,"竞技场",10003,2,3,10,"竞技当先，王座舍我其谁","竞技场商店可兑换武将碎片、进阶丹和培养丹",5,},  
    [2] = {2,"神将列传",10001,2,2,20,"体验神将列传，感受历史征途","大量产出武将碎片、兵符铸造石、兵符精华等珍稀资源",7,},  
    [3] = {3,"军团",10025,1,15,30,"我们热血同盟，一起征服三国","参加军团副本、军团铸像、可获丰富奖励",9,},  
    [4] = {4,"无双试炼",10009,1,20,40,"实力与策略的双重考验，攀登无双阁巅峰","产出橙装、红装、装备精炼石，打造一流装备",11,},  
    [5] = {5,"日常副本",10030,1,23,50,"日常资源，这里应有尽有","产出武将经验、兵符精华、银币、宝物经验等资源",13,},  
    [6] = {6,"秘境寻宝",10011,1,35,70,"搜尽天下秘境，炼铸绝世宝物","大量产出宝物、宝物精炼石，打造强力宝物",19,},  
    [7] = {7,"讨伐巨兽",10024,1,30,60,"打败机械巨兽，豪取战功！","产出兵符和兵符资源、装备资源。",17,},  
    [8] = {8,"神将列传战役",10032,7,6,55,"大战一触即发，组队横扫三国","大量产出兵符、兵符铸造石、兵符精华等珍稀资源",7,},  
    [9] = {9,"武将图鉴",1006,1,25,57,"天下名将，尽入吾彀中矣","激活武将图鉴，提供大量全体属性",14,},  
    [10] = {10,"过关斩将",10033,1,43,75,"过关斩将，建不世功勋","大量产出装备纹晶、宝物纹晶等珍稀资源",0,},  
    [11] = {11,"神兵",1900,1,50,80,"手握绝世神兵，号令天下群雄！","产出神兵和神兵锻造石，铸就无双神兵",0,},  
    [12] = {12,"心愿商店",20080,1,53,90,"每日许心愿，超多豪华礼物！","每日领取心愿奖励，兑换稀有道具",0,},  
    [13] = {13,"神翼",2100,1,48,85,"傲视四方，神翼飞扬！","进阶神翼，提供大量全体属性",0,},  
    [14] = {14,"神兽",2200,1,56,95,"至尊神兽，征服秘境仙岛！","培育神兽，战斗中成为最强助力",0,},  
    [15] = {15,"决战定军山",10037,1,63,97,"定军山上，迎战八方！","团队竞技，国士无双，受万人膜拜",0,},  
    [16] = {16,"兵临城下",10047,1,77,100,"兵临城下，斩尽来犯之敌！","共抗强敌，赚军团积分，赢命星占星盘。",0,},
    }
}
