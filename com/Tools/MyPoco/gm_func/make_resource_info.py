...
class MakeResourceInfo:
    ...
    def make_type_id(self,resource_name):
        ...
        :return:
        """
        self.this_type,self.this_id = self.grt.get_type_id(resource_name)
    ...
    def get_data_select(self,resource_name):
        ...
        return data
    def get_type_id_money(self,resource_name):
        """
        用于充值补单
        :param resource_name: 资源名
        :return: int 道具type、id
        """
        self.make_type_id(resource_name)
        return self.this_type,self.this_id
