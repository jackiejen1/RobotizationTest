...
class EntryGameShaoXia:
    ...
    def entry_game_shaoxia(self, sever_name_input, game_account_input):
        """
        ...
        if ("emulator" in self.phone_id) or ("127.0.0.1:"in self.phone_id):
            ...
            time.sleep(16)
        self.my_poco_obj.touch_poco("未命名0/popup/LoginAccountPop/__view/n5")
        ...
        self.my_poco_obj.touch_poco("未命名0/module/LoginLayer2/__view/Btn_server/title")#服务器
        self.my_poco_obj.touch_poco("未命名0/popup/LoginServerListPop/__view/List_kind_server/未命名1/title")  #切第一个区服列表# todo 不同游戏可能要改
        ...
        if self.my_poco_obj.is_in_dic("LoginLawPop/__view/btn_ok"):
            ...
            self.my_poco_obj.touch_poco("Btn_login")  # 开始游戏
        # self.my_poco_obj.touch_poco("Btn_girl")
        # self.my_poco_obj.touch_poco("Btn_boy")
        # self.my_poco_obj.touch_poco("Btn_random_name")#随机名字
        # self.my_poco_obj.touch_poco("Btn_enter/title")#进入游戏
        time.sleep(15)
