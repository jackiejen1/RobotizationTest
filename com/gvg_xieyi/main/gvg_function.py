...
class LoginGame:
    ...
    def MSG_C2S_GVG_EnterMatch(self, ):
        ...
        for guild_list in S2C_GVG_EnterMatch.guilds:  # 公会列表
            ...
            self.guild_index_dic[guild_num_str] = [guild_index]  # 军团ID当key
        self.match_user_dic = {}
        for user_list in S2C_GVG_EnterMatch.users:  # 比赛中的玩家列表
            self.match_user_dic[str(user_list.user.id)] = user_list.user.guild_id  # 玩家id k v 军团id
        ...
        for gate_list in S2C_GVG_EnterMatch.gates:  # 城门
            ...
            hp = gate_list.hp
            self.gate_dic[gate_num_str] = [grid_id, hp]
            gate_num = gate_num + 1
        buff_num = 1
        self.buff_dic = {}
        for buff_list in S2C_GVG_EnterMatch.buffs:  # BUFF点
            ...
            self.buff_dic[buff_num_str] = [grid_id, buff_id, end_time]
            buff_num = buff_num + 1
        tower_num = 1
        self.tower_dic = {}
    ...
    def S2C_GVG_NotifyUserEnter(self):
    ...
    def MSG_C2S_GVG_LeaveMatch(self, ):
        ...
        likaiwanjia_id = S2C_GVG_NotifyUserLeave.user_id  # 离开的玩家ID
