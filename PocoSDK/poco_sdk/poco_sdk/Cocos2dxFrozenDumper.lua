...
function FrozenDumper:dumpHierarchyImpl(node, onlyVisibleNode,nameIndex,bro_Name_list,bronameIndex,fatherName)
    local result,_nameIndexOut,_bro_Name_list,_bronameIndexOutput = AbstractDumper.dumpHierarchyImpl(self, node,onlyVisibleNode,nameIndex,bro_Name_list,bronameIndex,fatherName)
    ...
    return result,_nameIndexOut,_bro_Name_list,_bronameIndexOutput
end
